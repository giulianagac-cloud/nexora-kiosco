...
const ROL_LABEL = { admin: 'Administrador', cajero: 'Cajero', operador: 'Operador' }
  ...
  return (
    <aside className="w-56 bg-sidebar flex flex-col shrink-0">
      <div className="px-5 py-5 border-b border-slate-700">
        <h1 className="text-white font-bold text-lg tracking-tight">Nexora</h1>
        <p className="text-slate-400 text-xs mt-0.5">Punto de Venta</p>
      </div>
        ...
        {usuario && (
          <div className="flex items-center gap-2 mb-1">
            ...
            <div className="min-w-0">
              <p className="truncate text-xs font-medium text-slate-300">{usuario.nombre}</p>
              <p className="text-[10px] text-slate-500">{ROL_LABEL[usuario.rol] ?? usuario.rol}</p>
            </div>
          </div>
        )}
        <button
